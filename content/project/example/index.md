...
summary: >-
  ...
  Based on the county-level COVID-19 dataset in New York State from March to December 2020, this study conducted both spatial autocorrelation and spatiotemporal scanning statistical analysis to explore the spatiotemporal clustering patterns of COVID-19. Geodetector method was applied to investigate the geographic relationship between six environmental, demographic and economic factors and the spread of COVID-19 across the NYS. The results showed that the COVID-19 incidence rate has strong spatiotemporal heterogeneity. Both population density and temperature have significant effects on the spread of COVID-19. To control and prevent the spread of COVID-19, public health policies in New York State should be made based on careful considerations of supply of effective vaccines to COVID-19 variants to ensure a conservative epidemic prevention strategy. Future research can divide NYS into some sub-regions based on the spatiotemporal pattern detected in this study, and explore more underlying risk factors of COVID-19, such as medical resources and economic conditions, in these regions on weekly time scale. 
